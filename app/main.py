        ...
        try:
            ...
            if "sqlite" in str(engine.url):
                sqlite_statements = [
                    ...
                    "ALTER TABLE time_slots ADD COLUMN prize_money_cop INTEGER DEFAULT 0",
                    "ALTER TABLE time_slots ADD COLUMN prize_points INTEGER DEFAULT 0",
                    "ALTER TABLE time_slots ADD COLUMN tournament_category VARCHAR(50) DEFAULT '5ta'",
                    "ALTER TABLE time_slots ADD COLUMN is_closed BOOLEAN DEFAULT 0",
                    "ALTER TABLE time_slots ADD COLUMN spots_count INTEGER DEFAULT 0",
                    "ALTER TABLE time_slots ADD COLUMN match_type VARCHAR(50) DEFAULT 'MATCH'",
                ...
                pg_statements = [
                    ...
                    "ALTER TABLE time_slots ADD COLUMN IF NOT EXISTS prize_money_cop INTEGER DEFAULT 0",
                    "ALTER TABLE time_slots ADD COLUMN IF NOT EXISTS prize_points INTEGER DEFAULT 0",
                    "ALTER TABLE time_slots ADD COLUMN IF NOT EXISTS tournament_category VARCHAR(50) DEFAULT '5ta'",
                    "ALTER TABLE time_slots ADD COLUMN IF NOT EXISTS is_closed BOOLEAN DEFAULT FALSE",
