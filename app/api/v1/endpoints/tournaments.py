...
async def list_tournaments(
    ...
    for key, data in grouped.items():
        ...
        # Capacidad estimada: 4 parejas o 8 personas por 2 canchas (4 jugadores por cancha)
        total_cap = num_courts * 4
        booked_spots = total_cap if data["is_finished"] else max(4, total_cap - 2)
